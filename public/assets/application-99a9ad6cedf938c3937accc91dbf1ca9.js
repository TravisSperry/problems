...
(function() {
  jQuery(function() {
    ...
    return $('form').on('click', '.remove_fields', function(event) {
      ...
      $(this).closest('.attachment_fields').hide();
      return event.preventDefault();
    });
  });
...
(function() {
  jQuery(function() {
    return $('form').on('click', '#project-button', function() {
      return $('#processing-modal').modal('show');
    });
  });
...
(function() {
  jQuery(function() {
    var flashCallback, slideFade;
    $('.chosen').chosen({
      allow_single_deselect: true,
      no_results_text: 'No results matched',
      width: '100%'
    });
    slideFade = function(elem) {
      var fade;
      fade = {
        opacity: 0,
        transition: 'opacity 0.25s'
      };
      return elem.css(fade).slideUp();
    };
    flashCallback = function() {
      return slideFade($(".alert"));
    };
