...
class StandardsControllerTest < ActionController::TestCase
  ...
  test "should create standard" do
    assert_difference('Standard.count') do
      post :create, standard: { category: @standard.category, code: @standard.code, subcategory: @standard.subcategory }
    end
  ...
  test "should update standard" do
    patch :update, id: @standard, standard: { category: @standard.category, code: @standard.code, subcategory: @standard.subcategory }
    assert_redirected_to standard_path(assigns(:standard))
  end
